  ...
  if (isCropping && previewUrl) {
    return (
      <div className="flex flex-col items-center gap-4 p-4 sm:p-6 border-2 border-primary/30 rounded-lg bg-card w-full">
        ...
        <div className="relative w-full flex items-center justify-center rounded-lg bg-muted/20 border border-border md:max-w-[500px] md:mx-auto">
          <ReactCrop
            crop={crop}
  ...
  if (previewUrl && !uploadedImage) {
    return (
      <div className="flex flex-col items-center gap-4 sm:gap-6 p-4 sm:p-6 border-2 border-primary/30 rounded-lg bg-card w-full">
        ...
        <div className="relative w-full flex items-center justify-center overflow-hidden rounded-lg bg-muted/20 border border-border md:max-w-[500px] md:mx-auto" style={{ minHeight: '300px', maxHeight: '70vh' }}>
          <img
            src={previewUrl}
            alt="Preview"
