...
export const PolygonCanvas: React.FC<PolygonCanvasProps> = ({
  ...
  const draw32Gates8_1PadSlices = useCallback((polygonPoints: Point[], center: Point) => {
    ...
    const GATES_8_1_PAD_INTERNAL_OFFSET = 0; // Changed from 45 to 0, then apply -45 degrees, plus additional -3 and -4 degrees
    const rotationRad = ((rotationDegree + ROTATION_OFFSET + DEVTA_ADJUSTMENT + GATES_8_1_PAD_INTERNAL_OFFSET - 52) * Math.PI) / 180;
